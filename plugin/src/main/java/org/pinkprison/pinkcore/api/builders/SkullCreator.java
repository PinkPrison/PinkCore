...
public class SkullCreator {
    ...
    @Contract("_, _ -> param1")
    @Deprecated
    public static @NotNull ItemStack itemWithName(ItemStack item, String name) {
        notNull(item, "item");
        notNull(name, "name");
     ...
     */
    @Contract("_, _ -> param1")
    public static @NotNull ItemStack itemWithUuid(ItemStack item, UUID id) {
        notNull(item, "item");
        notNull(id, "id");
     ...
     */
    public static @Nullable ItemStack itemWithBase64(ItemStack item, String base64) {
        notNull(item, "item");
